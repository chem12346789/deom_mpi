...
#                                                       [(1, 40),
#                                                        (2, 50)], [0.0005]):
for vib_key, S_0, (npsd, lmax), ampl, dt in itertools.product([0], [0.4],
                                                              [(3, 60)], [0.1],
                                                              [0.01]):
    nmod = 2
    mu_a = 1.0
    ...
    temp = 77 * 0.69503457 / 200  # in 298K
    beta = 1 / temp
    ...
    # spe = D*D*phixx-2*D*phixy+phiyy+(barD+D*phixx-phixy)*(barD+D*phixx-phixy)*xqq
    ...
    sdip[0, 0, 1] = sdip[0, 1, 0] = 1.0 * mu_a
