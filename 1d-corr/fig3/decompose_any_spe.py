...
#                                                       [(1, 40),
#                                                        (2, 50)], [0.0005]):
for vib_key, S_0, npsd, lmax in itertools.product([1.0], [0.4], [1], [40]):
    nmod = 2
    omgs = 1.0  # in 200cm-1
    gams = 0.1  # in 20 cm-1
    ...
    cmd += r'mv input.json input.json' + \
        '_' + str(S_0) + '_' + str(vib_key) + \
        '_' + str(lmax) + '_' + str(npsd) + '&&'
