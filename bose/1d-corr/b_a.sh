...
gcc -g3 -march=native -Ofast -std=c++17 -I/usr/local/include -I/usr/local/include/eigen3 -pthread -lmpi -mfma -funroll-loops -mfpmath=sse -msse2 -fprefetch-loop-arrays -funsafe-loop-optimizations -ftracer -fbranch-probabilities linearalgebra.cpp -Wl,--start-group -lstdc++ -lm -ljson11 -fopenmp -lglog -lgflags -ldl -ldouble-conversion -lfolly -Wl,--end-group
# safe edition
